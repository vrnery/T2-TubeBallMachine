...
public class MapaMST {
    ...
    public void carregaPontos(String arquivo) throws IOException {
       lista = new ArrayList<>();
    ...
    public void montaGrafo() {
        ...
        ewg = new EdgeWeightedGraph(lista.size());
    ...
    public void geraSaida() throws IOException {
        ...
        try(PrintWriter pw = new PrintWriter(Files.newBufferedWriter(outpath, Charset.forName("utf8"))))
        {
            for(Edge e: ewg.edges()) {
                ...
                //if(c==1) // Descomente para ver só a árvore
                    pw.println(v+" "+o+" "+c);
            }
        }
        System.out.println(ewg.toDot());
    }

    public static void main(String[] args) throws IOException {
        MapaMST mapaMST = new MapaMST();
        mapaMST.carregaPontos("dados.csv");
        mapaMST.montaGrafo();
        mapaMST.geraSaida();
