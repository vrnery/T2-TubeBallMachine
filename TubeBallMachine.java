...
public class TubeBallMachine {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for(int i = 0; i<tuboCol; i++) {
                for(int j = 0; j < tuboRow; j++) {
                    ...
                    if(j>0) {
                        ...
                        vet.add(new int[]{tubos[i][j-1], tubos[i][j], 1});
                    }
                }
            }
            ...
            //     splitlinha = linha.split(" ");
            //     //dig.addEdge(new Edge(tubos[Integer.parseInt(splitlinha[0])][(Integer.parseInt(splitlinha[1])-1)], tubos[Integer.parseInt(splitlinha[2])][(Integer.parseInt(splitlinha[3])-1)], 0));
            //     //listEd.add(new Edge(tubos[Integer.parseInt(splitlinha[0])][(Integer.parseInt(splitlinha[1])-1)], tubos[Integer.parseInt(splitlinha[2])][(Integer.parseInt(splitlinha[3])-1)], 0));
            //     vet.add(new int[]{tubos[Integer.parseInt(splitlinha[0])][(Integer.parseInt(splitlinha[1])-1)], tubos[Integer.parseInt(splitlinha[2])][(Integer.parseInt(splitlinha[3])-1)], 0});
            // }
